---
title: "Rigging with RAG: How to build a retrieval augmented chatbot with Vertex AI"
description: "This talk explores the process of designing an AI chatbot using Retrieval Augmented Generation. We cover the technical components of building a RAG-powered chatbot using Vertex AI through a detailed code walkthrough. Following the walkthrough, there is a demo of the chatbot built using Vector Search and GCS. The nuances of building different kinds of knowledge bases and an evaluation framework for the decision to invest in chatbot development is also covered."
where: Women TechMakers & GDG Cloud, Singapore
date: 2024-04-18
