...
<section class='mt-4'>
    <div class='columns pt-6 px-4' style="max-width: 900px; margin: 0 auto;">
        <div class='pt-3 pb-6'>
            <p>
                Hi, I’m Akshata, a cloud architect, specialized in building in data applications. I am also a part of the <a target='_blank' href='https://developers.google.com/community/experts'>Google Developer Expert program for Artificial Intelligence and Machine Learning.</a>. Currently in Berlin, I split my time between Germany, Singapore and India. 
            </p>
            <br/>
            <p>
